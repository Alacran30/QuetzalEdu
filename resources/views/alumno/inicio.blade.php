...
@section('section')
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="col-lg-3">
        <center>
          <h5 style="border: solid 5px #c1d188;padding: 5px;margin-right: 20px;color:#7fa57b;margin-top: -5px;">GRUPOS</h5>
          <h5 style="border: solid 5px #c1d188;background-color:#c1d188;padding: 5px;margin-right: 20px;margin-top: -5px;color: #fff;">UNIRSE A UN GRUPO <span class="fa fa-users"></span> </h5>
          <h5 style="border: solid 5px #c1d188;padding: 5px;color:#7fa57b;margin-right: 20px;margin-top: -5px;">MIS CURSOS</h5>
          <a href="{{url('/competencias')}}"><h6 style="border: solid 5px #7fa57b;background-color:#7fa57b;padding: 5px;margin-right: 20px;margin-top: -5px;color: #fff;">Competencias Docentes</h6></a>
