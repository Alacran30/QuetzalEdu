                ...
                <ul id="sidemenu" class="sidebar-nav">
                    ...
                    <li>
                        <a href="{{url('/users')}}">
                            ...
                            <a href="{{url('/users')}}" class="aside"><span class="sidebar-title"><font color="#94c160">Gestión de usuarios</font></span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/pagos')}}"> 
...
<div class="list" style="background-color:#ffffff;">
                ...
                <img class="img-responsive" src="{{asset('img/Admin6.png')}}">
...
educación básica y media superior (etapa 1).</h5><br>
                ...
                <img class="img-responsive" src="{{asset('img/cintaAdmin2.png')}}"><br>
                 ...
                 <a href="{{ route('users.create') }}"><button class="button1" class="btn btn-success" data-toggle="modal" data-target="#agregar"> <i class="fa fa-plus"></i> &nbsp;Registrar Instructor</button></a>

                <form class="navbar-form pull-right" style="margin-top: 0px;margin-right: -15px;">
                  <div class="input-group">
                    {!! Form::text('nombre',null, ['class' => 'form-control', 'placeholder' => ' Buscar | Usuario ', 'aria-describedby' => 'search']) !!}
    ...
    @foreach($user as $users)
      <tr>
        ...
        <td style="font-size: 16px;">
          ...
          <p><span class="label label-danger" >{{ $users->tipo->tipo }}</span></p>
          @endif
          @if($users->tipo->tipo == "Instructor")
          <p><span class="label label-primary">{{ $users->tipo->tipo }}</span></p>
          @endif
          @if($users->tipo->tipo == "Alumno")
          <p> <span class="label label-success">{{ $users->tipo->tipo }}</span></p>
          @endif
        </td>
        <td>
        ...
        <td>
          @if($users->tipo->tipo == "Administrador")
            <a onclick="return confirm('El administrador del sistema no puede ser eliminado')" class="btn btn-danger action"> <span class="glyphicon glyphicon-trash"></span></a>
          @else
