                ...
                <ul id="sidemenu" class="sidebar-nav">
                    ...
                    <li>
                        <a href="{{url('/ControlPagos')}}"> 
                            ...
                            <a href="{{url('/pagos')}}" class="aside"><span class="sidebar-title"><font color="#94c160">Control de pagos</font></span>
                        </a>
                    </li>
                </ul>
            </aside>            
...
<div class="list" style="background-color:#ffffff;">
                ...
                <img class="img-responsive" src="{{asset('img/Admin7.png')}}">
                
                </div>
                <div class="col-lg-9">
                <h5><strong>Control de pagos</strong></h5>
