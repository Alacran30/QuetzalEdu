...
<div class="list" style="background-color:#ffffff;">
                ...
                <div class="col-lg-9">
                <h5><strong>Lista de áreas de conocimiento.</strong></h5>
...
educación básica y media superior (etapa 1).</h5><br>
                ...
                <img class="img-responsive" src="{{asset('img/cintaAdmin2.png')}}"><br>
                 ...
                 <button class="button1" class="btn btn-success" data-toggle="modal" data-target="#agregar"> <i class="fa fa-plus"></i> &nbsp;Agregar área de conocimiento</button>

                 <form class="navbar-form pull-right" style="margin-top: 0px;margin-right: -15px;">
  <div class="input-group">
    {!! Form::text('area_conocimiento',null, ['class' => 'form-control', 'aria-describedby' => 'search', 'placeholder' => ' Buscar | Nombre']) !!}
  ...
  <tbody>
    @foreach($area as $areas)
      <tr>
        ...
        <td>
          <a href="{{ route('area.destroy', $areas->id) }}" onclick="return confirm('¿Está seguro de eliminar el área de conocimiento definitivamente?')" class="btn btn-danger action"> <span class="glyphicon glyphicon-trash"></span></a>
        </td>
      </tr>
    @endforeach
  </tbody>
