...
@section('title', 'Curso Competencias Docentes')

@section('section')

<style>
.bg-no-overlay {
    background: url("img/C1P2.jpg");
    ...
    <div class="row text-center">
        <div class="col-md-12">
            ...
            <div class="col-md-6" style="padding-bottom: 150px;"><br><br>
                <div class="embed-responsive embed-responsive-16by9" id="grad2">
  ...
  <div class="col-md-12"><br><br><br><br>
      <div class="col-md-4">
          <div class="panel panel-default">
              <div class="panel-heading">
                  <center>
                          <font size="5" color="#638742">DESCRIPCIÓN DEL CURSO</font>
                  </center>
              </div>
      ...
      <div class="col-md-4">
          <div class="panel panel-default">
              <div class="panel-heading">
                  <center>
                          <font size="5" color="#638742">OBJETIVO DEL CURSO</font>
                  </center>
              </div>
              <div class="panel-body">
                  <p class="text-justify"><br>Capacitación en competencias aquí el docente se puede capacitarse en los diez dominios de competencias consideradas en la formación continua de docentes de acuerdo a los perfiles, parámetros e indicadores de los planes de estudio vigentes.<br>
      ...
      <div class="col-md-4">
          <div class="panel panel-default">
              <div class="panel-heading">
                  <center>
                          <font size="5" color="#638742">ALCANCE DEL CURSO</font>
                  </center>
              </div>
              <div class="panel-body">
                  <p class="text-justify"><br>Capacitación en competencias aquí el docente se puede capacitarse en los diez dominios de competencias consideradas en la formación continua de docentes de acuerdo a los perfiles, parámetros e indicadores de los planes de estudio vigentes.<br>
...
<div class="container">
  <div class="col-md-12"><br><br>
    <div class="col-lg-4 col-lg-offset-4"><br>
      <div class="panel panel-default" style="background-color: #638742;border-radius: 10px;"><br>
        ...
        <div class="panel-heading"><br><br>
          <font size="3" color="#638742">- Acceso a Videos</font><br><br>
          <font size="3" color="#638742">- Acceso a Competencias Docentes</font><br><br><br>
