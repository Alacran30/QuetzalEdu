...
@section('section')
 ...
 <hr>
  ...
  <div class="col-md-5 center-block quitarfloat" style="font-weight: bold;">
    <div>
      ...
      {!!Form::open(['route'=>'log', 'method'=>'POST'])!!}
        <div class="form-group has-feedback">
          <input type="email" name="email" class="form-control" placeholder="Correo electrónico / Usuario" required />
    ...
    <!-- <div>
      <a href="{{ url('/registro') }}" class="btn btn-danger pull-left">Regístrate Aquí</a>
    </div> -->
  </div>
  </div>
